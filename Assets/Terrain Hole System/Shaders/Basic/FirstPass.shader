Shader "TRI/THS/Basic"
{
	...
	CGINCLUDE
		#pragma surface surf Lambert vertex:SplatmapVert alphatest:_AlphaCutoff_2 finalcolor:myfinal finalprepass:SplatmapFinalPrepass finalgbuffer:SplatmapFinalGBuffer
